...
export default function DialogForAddStream({ userId }: { userId: number }) {
    ...
    return (
        <Dialog>
            <div className={`flex flex-row justify-end gap-3 text-${typography}`}>
                <div className="flex flex-row gap-3">
                    <Popover>
                        <PopoverTrigger asChild className="hover:cursor-pointer" onClick={() => {
                            ...
                            <Avatar className="w-9 h-9 mt-[1px] mr-1 ">
                        ...
                        <PopoverContent className="w-39 h-70 mr-19 flex flex-col bg-[#071919]">
                    ...
                    <Popover>
                        ...
                        <PopoverContent className="w-70 h-70 mr-30 bg-[#071919]">
                ...
                <Button className={`w-10 mt-[1px] bg-[#e80082]`} onClick={async () => {
                    setLinkCopy(true);
                ...
                <DialogTrigger className="w-40" asChild>
                    <Button className={`w-40 mr-7 hover:cursor-pointer bg-[#e80082]`}><PlusIcon />Create New Stream</Button>
                </DialogTrigger>
